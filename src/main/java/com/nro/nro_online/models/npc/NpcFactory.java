...
import com.nro.nro_online.models.npc.npc_forge.GhiDanh;
import com.nro.nro_online.models.npc.npc_forge.NoiBanh;
import com.nro.nro_online.models.npc.npc_forge.QuyLaoKame;
...
import com.nro.nro_online.models.npc.npc_forge.*;
            ...
            public void confirmMenu(Player player, int select) {
                ...
                case ConstNpc.SHENRON_CONFIRM:
                    if (select == 0) {
                        ...
                        SummonDragon.gI().reOpenWishMenu(null);
                    }
                    break;
                ...
                default:
                    SummonDragon.gI().showConfirmWish(player, player.iDMark.getIndexMenu(), (byte) select);
                    break;
                }
            }
        };
            ...
            public void confirmMenu(Player player, int select) {
                ...
                case ConstNpc.SUMMON_SHENRON:
                    if (select == 0) {
                        ...
                        SummonDragon.gI().summonDragon(player, DragonType.SHENRON);
                    }
                    break;
                case ConstNpc.SUMMON_BLACK_SHENRON:
                    if (select == 0) {
                        SummonDragon.gI().summonDragon(player, DragonType.BLACK_SHENRON);
                    }
                    break;
                case ConstNpc.SUMMON_ICE_SHENRON:
                    if (select == 0) {
                        SummonDragon.gI().summonDragon(player, DragonType.ICE_SHENRON);
                    }
                    break;
