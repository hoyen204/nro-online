package com.nro.nro_online.consts;
...
public class ConstNpc {
    ...
    public static final int NAU_BANH_2_TRUNG = 603;
    public static final int LAY_BANH_1_TRUNG = 604;
    public static final int LAY_BANH_2_TRUNG = 605;
    ...
    public static final int COORDINATES = 523;
    public static final int CONFIRM_DISSOLUTION_CLAN = 523;
    public static final int CONFIRM_DIALOG = 522;
    public static final int CONFIRM_ACTIVE = 524;
    ...
    public static final int SHOP_GIAM_GIA = 517;
    public static final int SHOP_TORIBOT = 518;
    public static final int SHOP_LEARN_SKILL = 519;
