...
public class UseItem {
        ...
        if (time != 0) {
            ...
            for (var i : listClothesReward) {
                ...
                RewardService.gI().initStarOption(itemReward,
                        new RewardService.RatioStar[] { new RewardService.RatioStar((byte) 1, 1, 2), new RewardService.RatioStar((byte) 2, 1, 3),
    ...
    private void openEggLinhThu(Player player, Item item) {
        ...
        Service.getInstance()
                .sendThongBao(player, "Bạn đã nhận được Trứng Linh Thú ở Sân Sau Siêu Thị\nLưu ý nếu không thấy Trứng vui lòng Thoát Game vào lại!");
        InventoryService.gI().subQuantityItemsBag(player, item, 1);
        InventoryService.gI().sendItemBags(player);
    }
    ...
    private void controllerCallRongThan(Player pl, Item item) {
        ...
        if (tempId >= SummonDragon.NGOC_RONG_1_SAO && tempId <= SummonDragon.NGOC_RONG_7_SAO) {
            ...
            case SummonDragon.NGOC_RONG_1_SAO:
                ...
                break;
            default:
                NpcService.gI().createMenuConMeo(pl, ConstNpc.TUTORIAL_SUMMON_DRAGON, -1, "Bạn chỉ có thể gọi rồng từ ngọc 3 sao, 2 sao, 1 sao",
                        "Hướng\ndẫn thêm\n(mới)", "OK");
                break;
            }
